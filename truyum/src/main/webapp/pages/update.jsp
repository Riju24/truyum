...
<form action ="update" method ="post" >
	...
	<div class="row">
		<div class="col-3">
			Id : <input type = "text" id = "id" name ="id" value="${item.id}" required/>
		</div>
		<div class ="col-9">
			Name : <input type = "text"  id = "name" name ="name" value="${item.name}"required/>
		</div>
	</div>
	<br/>
	<div class ="row">
		<div class="col-3">
			Price :<input type = "text" id = "price" name ="price" value="${item.price}"required/>
		</div>
		<div class="col-2">
			Active :
			<br/>
